    ...
    <table class='w-full whitespace-nowrap rounded-lg bg-white divide-y divide-systems-300 '>
        ...
        <thead v-else class="bg-systems-900 ">
            <tr class="text-white text-center">
                <th class="font-semibold text-sm uppercase px-2 py-4 text-left"> Фактура </th>
                <th v-if="props.showRecruiter" class="font-semibold text-sm uppercase px-6 py-4 text-left"> Рерутер
                </th>
                <th class="font-semibold text-sm uppercase px-2 py-4 text-left"> Клиент </th>
                <th class="font-semibold text-sm uppercase px-2 py-4 text-left"> Проект </th>
                <th class="font-semibold text-sm uppercase px-2 py-4 text-center"> Статус </th>
