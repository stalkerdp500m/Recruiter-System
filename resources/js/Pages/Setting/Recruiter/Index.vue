    ...
    <MainLayout>
        ...
        <div class="md:px-10">
            ...
            <div class="bg-white my-2 p-3 rounded-md shadow-md   " v-for="(recruiter, i) in filteredRecruiterList"
                ...
                <div
                    class=" py-4 border-t-2 border-systems-700/50   w-full gap-2  flex  items-center md:justify-start justify-evenly flex-wrap">
                    <div class=" w-full flex bg-systems-300 items-center px-2 rounded-md">
                        <h3 class="font-semibold ">В команде</h3>
                        <div class="flex items-center m-2 md:w-1/2">
                    ...
                    <div class="w-full flex bg-systems-300 items-center px-2 rounded-md">
                        <h3 class=" font-semibold">Владелец</h3>
                        <div class="flex items-center m-2 md:w-1/2">
                            <VueMultiselect @update:model-value="recruiterOwnerUpdate($event, recruiter)"
                                :multiple="false" selectLabel="" track-by="name" deselectLabel="убрать из этой команды"
                                v-model="recruiter.owner" :options="props.userList" label="name" :searchable="true"
